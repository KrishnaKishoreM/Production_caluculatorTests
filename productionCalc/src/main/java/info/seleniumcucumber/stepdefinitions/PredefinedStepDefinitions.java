...
public class PredefinedStepDefinitions implements BaseTest {
	...
	@And("^I enter \"([^\"]*)\" into input field having xpath \"([^\"]*)\"panel\"([^\"]*)\"$")
	public void iEnterIntoInputFieldHavingXpathPanel(String text, String type,String accessName) throws Exception {
		miscmethodObj.validateLocator(type);
		inputObj.enterText(type, text, accessName);
